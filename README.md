...
and transfer to their wallet plus any other wallet that is defined in the system.

The application has custom IBAN validators can easily be applied to any IBAN field via annotation as shown below:
